#ifndef NARUTOACM_OPEMUL_H_
#define NARUTOACM_OPEMUL_H_
...
protected:
    ...
    static int rows(const BinaryExpr<eT,M,N,OpEMul,ExprT1,ExprT2> &expr)
    {
        return expr.expr1_.Rows();
    }
    template <typename eT, int M, int N, typename ExprT1, typename ExprT2>
    static int cols(const BinaryExpr<eT,M,N,OpEMul,ExprT1,ExprT2> &expr)
    {
        return expr.expr1_.Cols();
    }

    template <typename eT, int M, int N, typename ExprT1, typename ExprT2>
    static eT eval(const BinaryExpr<eT,M,N,OpEMul,ExprT1,ExprT2> &expr, int idx)
    {
    ...
    template <typename eT, int M, int N, typename ExprT1, typename ExprT2>
    static eT eval(const BinaryExpr<eT,M,N,OpEMul,ExprT1,ExprT2> &expr, int r, int c)
    {
        typedef typename prio_type<typename prio_type<typename element_type<ExprT1>::type, eT>::result_type, typename element_type<ExprT2>::type>::result_type T;
    ...
    static void emul(eT *res, int len, const Matrix<eT1,M1,N1> &expr1, const Matrix<eT2,M2,N2> &expr2, Cache &cache)
    {
    ...
    static void emul(eT *res, int len, const SimpleMatrixBase<expreT1,ExprT1> &expr1, const SimpleMatrixBase<expreT2,ExprT2> &expr2, Cache &cache)
    {
    ...
    template <typename eT, typename expreT1, typename ExprT1, typename expreT2, typename ExprT2>
    static void emul(eT *res, int len, const MatrixBase<expreT1,ExprT1> &expr1, const SimpleMatrixBase<expreT2,ExprT2> &expr2, Cache &cache)
    {
        auto &mat1 = expr1.Derived();
        auto &mat2 = expr2.Derived();
        ...
        else
        {
            ...
            emul((T *)(block->ptr), block->size / sizeof(T), mat1, mat2, cache);
    ...
    template <typename eT, typename expreT1, typename ExprT1, typename expreT2, typename ExprT2>
    static void emul(eT *res, int len, const SimpleMatrixBase<expreT1,ExprT1> &expr1, const MatrixBase<expreT2,ExprT2> &expr2, Cache &cache)
    {
        auto &mat1 = expr1.Derived();
        auto &mat2 = expr2.Derived();
    ...
    template <typename eT, typename expreT1, typename ExprT1, typename expreT2, typename ExprT2>
    static void emul(eT *res, int len, const MatrixBase<expreT1,ExprT1> &expr1, const MatrixBase<expreT2,ExprT2> &expr2, Cache &cache)
    {
        auto &mat1 = expr1.Derived();
        auto &mat2 = expr2.Derived();
    ...
    static void emul(Matrix<eT,M,N> &res, const SimpleMatrixBase<expreT1,ExprT1> &expr1, const SimpleMatrixBase<expreT2,ExprT2> &expr2, Cache &cache)
    {
        auto &mat1 = expr1.Derived();
        auto &mat2 = expr2.Derived();
        ...
        if (ar == 0 && br == 0)
        {
            ...
            emul(res.Data(), res.Capacity(), mat1, mat2, cache);
        }
        else if (ar == 2 || br == 2)
        {
    ...
    template <typename eT, int M, int N, typename expreT1, typename ExprT1, typename expreT2, typename ExprT2>
    static void emul(Matrix<eT,M,N> &res, const MatrixBase<expreT1,ExprT1> &expr1, const SimpleMatrixBase<expreT2,ExprT2> &expr2, Cache &cache)
    {
        auto &mat1 = expr1.Derived();
        auto &mat2 = expr2.Derived();
    ...
    template <typename eT, int M, int N, typename expreT1, typename ExprT1, typename expreT2, typename ExprT2>
    static void emul(Matrix<eT,M,N> &res, const SimpleMatrixBase<expreT1,ExprT1> &expr1, const MatrixBase<expreT2,ExprT2> &expr2, Cache &cache)
    {
        auto &mat1 = expr1.Derived();
        auto &mat2 = expr2.Derived();
    ...
    template <typename eT, int M, int N, typename expreT1, typename ExprT1, typename expreT2, typename ExprT2>
    static void emul(Matrix<eT,M,N> &res, const MatrixBase<expreT1,ExprT1> &expr1, const MatrixBase<expreT2,ExprT2> &expr2, Cache &cache)
    {
        auto &mat1 = expr1.Derived();
        auto &mat2 = expr2.Derived();
    ...
    static void eval(eT1 *res, int len, const BinaryExpr<eT2,M,N,OpEMul,ExprT1,ExprT2> &expr, Cache &cache)
    {
        emul(res, len, expr.expr1_, expr.expr2_, cache);
    }
    template <typename eT1, int M1, int N1, typename eT2, int M2, int N2, typename ExprT1, typename ExprT2>
    static void eval(Matrix<eT1,M1,N1> &res, const BinaryExpr<eT2,M2,N2,OpEMul,ExprT1,ExprT2> &expr, Cache &cache)
    {
        emul(res, expr.expr1_, expr.expr2_, cache);
    }
    
protected:
    template <typename eT1, int M1, int N1, typename eT2, int M2, int N2, typename ExprT1, typename ExprT2>
    OpEMul(Matrix<eT1,M1,N1> &mat, const BinaryExpr<eT2,M2,N2,OpEMul,ExprT1,ExprT2> &expr)
        : Op(mat, expr)
    {
    }
...
inline const BinaryExpr<typename prio_type<expreT1,expreT2>::result_type,
                        ...
                        OpEMul, ExprT1, ExprT2> ElementMulti(const MatrixBase<expreT1,ExprT1> &expr1, const MatrixBase<expreT2,ExprT2> &expr2)
{
    assert(expr1.Rows() == expr2.Rows() && expr1.Cols() == expr2.Cols());
    return GenBinaryExpr<typename prio_type<expreT1,expreT2>::result_type,
                        max<meta::rows<ExprT1>::value,meta::rows<ExprT2>::value>::result,
                        max<meta::cols<ExprT1>::value,meta::cols<ExprT2>::value>::result,
                        OpEMul>(expr1.Derived(), expr2.Derived());
}
