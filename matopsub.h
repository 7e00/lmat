#ifndef NARUTOACM_MATOPSUB_H_
#define NARUTOACM_MATOPSUB_H_
...
public:
    ...
    static BinaryExpr<eT,M,N,MatOpSub,ExprT1,ExprT2> GenBinaryExpr(const MatrixBase<eT1,ExprT1> &expr1, const MatrixBase<eT2,ExprT2> &expr2)
    {
        return BinaryExpr<eT,M,N,MatOpSub,ExprT1,ExprT2>(expr1.Derived(), expr2.Derived());
    }

protected:

    template <typename eT, int M, int N, typename ExprT1, typename ExprT2>
    static int rows(const BinaryExpr<eT,M,N,MatOpSub,ExprT1,ExprT2> &expr)
    {
        return expr.expr1_.Rows();
    }
    template <typename eT, int M, int N, typename ExprT1, typename ExprT2>
    static int cols(const BinaryExpr<eT,M,N,MatOpSub,ExprT1,ExprT2> &expr)
    {
        return expr.expr1_.Cols();
    }

    template <typename eT, int M, int N, typename ExprT1, typename ExprT2>
    static eT eval(const BinaryExpr<eT,M,N,MatOpSub,ExprT1,ExprT2> &expr, int idx)
    {
    ...
    template <typename eT, int M, int N, typename ExprT1, typename ExprT2>
    static eT eval(const BinaryExpr<eT,M,N,MatOpSub,ExprT1,ExprT2> &expr, int r, int c)
    {
        typedef typename prio_type<typename prio_type<typename element_type<ExprT1>::type, eT>::result_type, typename element_type<ExprT2>::type>::result_type T;
    ...
    static void sub(EntityMatrixBase<eT,ExprT> &res, const SimpleMatrixBase<eT1,ExprT1> &expr1, const SimpleMatrixBase<eT2,ExprT2> &expr2, Cache &cache, int relation1 = -1, int relation2 = -1)
    {
        ...
        else if (relation1 == 2 || relation2 == 2)
        {
            ...
            sub(ms, expr1.Derived(), expr2.Derived(), cache, 0, 0);
    ...
    template <typename eT, typename ExprT, typename eT1, typename ExprT1, typename eT2, typename ExprT2>
    static void sub(EntityMatrixBase<eT,ExprT> &res, const MatrixBase<eT1,ExprT1> &expr1, const SimpleMatrixBase<eT2,ExprT2> &expr2, Cache &cache, int relation1 = -1, int relation2 = -1)
    {
        relation1 = (relation1 >= 0 ? relation1 : relation_to_mat(res, expr1.Derived()));
        relation2 = (relation2 >= 0 ? relation2 : relation_to_mat(res, expr2.Derived()));
        ...
        {
            MatOp::eval(res, expr1.Derived(), cache, 0);
            sub(res, res, expr2.Derived(), cache, 1, 0);
        }
        else
        {
            sub<eT,meta::rows<ExprT>::value,meta::cols<ExprT>::value>(expr1.Derived(), expr2.Derived(), cache);
    ...
    template <typename eT, typename ExprT, typename eT1, typename ExprT1, typename eT2, typename ExprT2>
    static void sub(EntityMatrixBase<eT,ExprT> &res, const SimpleMatrixBase<eT1,ExprT1> &expr1, const MatrixBase<eT2,ExprT2> &expr2, Cache &cache, int relation1 = -1, int relation2 = -1)
    {
        relation1 = (relation1 >= 0 ? relation1 : relation_to_mat(res, expr1.Derived()));
        relation2 = (relation2 >= 0 ? relation2 : relation_to_mat(res, expr2.Derived()));
        ...
        {
            MatOp::eval(res, expr2.Derived(), cache, 0);
            sub(res, expr1.Derived(), res, cache, 0, 1);
        }
        else
        {
            sub<eT,meta::rows<ExprT>::value,meta::cols<ExprT>::value>(expr1.Derived(), expr2.Derived(), cache);
    ...
    template <typename eT, typename ExprT, typename eT1, typename ExprT1, typename eT2, typename ExprT2>
    static void sub(EntityMatrixBase<eT,ExprT> &res, const MatrixBase<eT1,ExprT1> &expr1, const MatrixBase<eT2,ExprT2> &expr2, Cache &cache, int relation1 = -1, int relation2 = -1)
    {
        relation1 = (relation1 >= 0 ? relation1 : relation_to_mat(res, expr1.Derived()));
        relation2 = (relation2 >= 0 ? relation2 : relation_to_mat(res, expr2.Derived()));
    ...
    template <typename eT, int M, int N, typename eT1, typename ExprT1, typename eT2, typename ExprT2>
    static void sub(const SimpleMatrixBase<eT1,ExprT1> &expr1, const SimpleMatrixBase<eT2,ExprT2> &expr2, Cache &cache)
    {
        auto block = cache.Acquire();
    ...
    template <typename eT, int M, int N, typename eT1, typename ExprT1, typename eT2, typename ExprT2>
    static void sub(const MatrixBase<eT1,ExprT1> &expr1, const SimpleMatrixBase<eT2,ExprT2> &expr2, Cache &cache)
    {
        ...
        sub(ms, ms1, expr2.Derived(), cache, 1, 0);
        cache.StoreResult(block1);
    }
    template <typename eT, int M, int N, typename eT1, typename ExprT1, typename eT2, typename ExprT2>
    static void sub(const SimpleMatrixBase<eT1,ExprT1> &expr1, const MatrixBase<eT2,ExprT2> &expr2, Cache &cache)
    {
        ...
        sub(ms, expr1.Derived(), ms2, cache, 0, 1);
        cache.StoreResult(block2);
    }
    template <typename eT, int M, int N, typename eT1, typename ExprT1, typename eT2, typename ExprT2>
    static void sub(const MatrixBase<eT1,ExprT1> &expr1, const MatrixBase<eT2,ExprT2> &expr2, Cache &cache)
    {
        ...
        MatrixShell<eT,M,N> ms((eT *)(block1->ptr), block1->size/sizeof(eT));
        sub(ms, ms1, ms2, cache, 1, 0);
        cache.StoreResult(block1);
    }
    
    template <typename eT1, typename ExprT1, typename eT2, int M, int N, typename ExprT2, typename ExprT3>
    static void eval(EntityMatrixBase<eT1,ExprT1> &res, const BinaryExpr<eT2,M,N,MatOpSub,ExprT2,ExprT3> &expr, Cache &cache, int relation = -1)
    {
        relation = (relation == 0 ? 0 : -1);
        sub(res, expr.expr1_, expr.expr2_, cache, relation, relation);
    }
    template <typename eT, int M, int N, typename eT1, int M1, int N1, typename ExprT1, typename ExprT2>
    static void eval(const BinaryExpr<eT1,M1,N1,MatOpSub,ExprT1,ExprT2> &expr, Cache &cache)
    {
        sub<eT,M,N>(expr.expr1_, expr.expr2_, cache);
    }
    
protected:
    template <typename eT1, typename ExprT1, typename eT2, int M, int N, typename ExprT2, typename ExprT3>
    MatOpSub(EntityMatrixBase<eT1,ExprT1> &mat, const BinaryExpr<eT2,M,N,MatOpSub,ExprT2,ExprT3> &expr, int relation = -1)
...
inline const BinaryExpr<typename prio_type<expreT1,expreT2>::result_type,
                        ...
                        MatOpSub, ExprT1, ExprT2> operator-(const MatrixBase<expreT1,ExprT1> &expr1, const MatrixBase<expreT2,ExprT2> &expr2)
{
    assert(expr1.Rows() == expr2.Rows() && expr1.Cols() == expr2.Cols());
    return MatOpSub::GenBinaryExpr<typename prio_type<expreT1,expreT2>::result_type,
                        max<meta::rows<ExprT1>::value,meta::rows<ExprT2>::value>::result,
                        max<meta::cols<ExprT1>::value,meta::cols<ExprT2>::value>::result>
